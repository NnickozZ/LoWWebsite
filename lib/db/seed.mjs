...
/** §66: de naam die van een familie is en niet van een persoon. */
const ACHTERNAAM_VELD = { key: 'achternaam', label: 'Achternaam', kind: 'text' };
...
const stamboomVelden = (slug) =>
  STAMBOOM_MENSEN.includes(slug)
    ? [...STAMBOOM_KERN(slug), ACHTERNAAM_VELD]
...
export const ENTRY_TYPES = [
  {
    ...
    fields: [
      ...
      VEREERT_VELD,
      // §66: Ouders, Kinderen, Partner en de Achternaam. In een vers archief
      // staan ze hier; in een bestaand archief plakt `seed:round-31-stamboom`
      // ze er één keer bij, zodat de twee hetzelfde zeggen.
